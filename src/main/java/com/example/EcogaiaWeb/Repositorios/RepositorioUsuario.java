...
public interface RepositorioUsuario extends CrudRepository<Usuario, Integer> {
    ...
    @Query(value = "select u.id_Usuario, u.usu_nombre, u.usu_correo, u.usu_direccion, u.usu_contrasenia, u.usu_telefono from Usuario as u where usu_correo =:correo", nativeQuery = true)
